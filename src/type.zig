...
pub const TypeVal = union(enum) {
    primitive_nn: PrimitiveTypeVals,
...
pub const PrimitiveTypeVals = union(PrimitiveType) {
    undef: void,
    bool: bool,
    byte: u8,
    bytes: []u8,
...
pub const NumTypeVals = union(Numbers) {
    num: anytype,
    complex,
    decimal,
...
pub const Field = struct {
    ...
    pub fn matches(self: Self, f: FieldIdent) bool {
